  ...
  <nav class="w-full bg-white border-gray-200 px-2 sm:px-4 rounded lg:hidden">
    <div class="flex flex-wrap items-center justify-between mx-auto">
      ...
      <div class="flex items-center lg:order-2">
        <button
          type="button"
          class="flex mr-3 text-sm h-10 w-10 rounded-full lg:mr-0"
          id="user-menu-button"
          aria-expanded="false"
      ...
      <div
        class="items-center justify-between hidden w-full lg:hidden lg:w-auto lg:order-1"
        id="mobile-menu-2"
      >
        <ul
        ...
        >
          <li>
            <a
              href="#"
              class="block py-2 pl-3 pr-4 text-white bg-blue-700 rounded lg:bg-transparent lg:text-blue-700"
              aria-current="page"
              >Home</a
            >
          </li>
